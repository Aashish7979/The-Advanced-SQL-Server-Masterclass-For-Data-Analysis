--Optimization using Update statement.
--Starter Code:
...
--Excersie --Starter code
----Re-write an optimized version of the below query using temp tables and UPDATE statements:
--Exercise
--Making use of temp tables and UPDATE statements, re-write an
--optimized version of the query in the "Optimizing With UPDATE -
--Exercise Starter Code.sql" file, which you'll find in the resources for
--this section.
